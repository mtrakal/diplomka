...
\usepackage[a4paper,inner=3.5cm,outer=2.5cm,top=2.5cm,bottom=2.5cm]{geometry} % velikost vnějšího okraje stránek
...
\usepackage[hyphens]{url} 			% tends to give much more nicely formatted web addresses
...
\pagenumbering{Alph}											% změní číslování stránek, je tu kvůli jednomu warningu
% Desky pro tištěnou verzi
\include{struct/01Desky}

\pagenumbering{arabic}										% vrátí číslování stránek, je tu kvůli jednomu warningu
% Úvodní strana
...
\renewcommand{\baselinestretch}{1.5} 			% velikost řádkování
% Prohlášení autora
