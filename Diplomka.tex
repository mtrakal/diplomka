...
%\usepackage{czech}				 			% nastavuje zásady typografie pro českou sazbu pomocí csLaTeXu
...
% Pro nastavení písma se musí anstavit fontenc na uvedený u písma a následně písmo, nejlépe písma začínající il2xxxx.fd
% Umístění písem: d:\Software\LaTeX_MikTeX_portable\tex\latex\cslatex\
\usepackage[IL2]{fontenc} 			% fonty vyladěné pro češtinu (obávám se, že je to nepoužívá :()
%\usepackage[T1]{fontenc} 			% běžné fonty
...
%\usepackage[nottoc]{tocbibind}	% přidá do obsahu Bibliografii - nevím, jak se používá...
...
% nejde s tím pak vygenerovat obsah a další věci
